# ACE Ontology (Constitutional Layer)

## 1. Purpose
The ACE Ontology defines the immutable structure of ecological reality as expressed
in the ACE Protocol. It is logically coherent, internally consistent, and permanently 
valid across all sectors, technologies, and scientific eras.

ACE does not optimize, calculate, or interpret. 
It defines the constitutional classes, axioms, and boundaries that all implementations 
must obey.

Applications may change. 
The ontology may not.

---

## 2. Constitutional Axioms

### 2.1 Separation of Ontology and Application
- The ontology is permanent. 
- Implementations are adaptive. 
No empirical update, technological innovation, or scientific discovery may alter:
- the ontological classes 
- their boundaries 
- their order 
- the constitutional axioms 

### 2.2 The Consequence Axiom
No rule, parameter, or interpretation may:
- introduce contradiction 
- violate ontological order 
- create non‑generalizable exceptions 

This axiom overrides all other sections.

---

## 3. Ontological Classes

ACE defines seven immutable classes:

**G, O, B, M, T, E, C**

These classes describe what exists at the most fundamental level. 
They stand above all models, parameters, and sectoral implementations.

### 3.1 Class Boundaries
- **G** - geological substrate 
- **O** - inert organic substrate without nitrogen 
- **B** - biological capital (all mineralizable organic N) 
- **M** - mineral N capital 
- **T** - technical capital 
- **E** - economic capital 
- **C** - climate representation class 

### 3.2 Substrate vs Capital
- Substrate: **G, O** 
- Capital: **B, M, T, E** 
- Representation: **C**

Nitrogen (N), climate impact (CO2e), and economic value ($) are parallel currencies. 
Currencies do not define ontology; ontology defines the classes that currencies operate
within.
...
Each class requires the existence of the class before it, but never the class after it. 
This expresses ontological dependence, not physical location or causal flow.
...
Revisions may never alter the ontology or its purpose.

---

## 6. Custodianship
ACE Foundation serves as the custodian of the ACE ontology, methodology, and governance
framework. Custodianship concerns the protection and continuity of the protocol and does
not include operational implementation rights, which remain exclusively with the 
originator unless licensed or transferred.

---

## 7. Constitutional Permanence
